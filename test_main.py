...
def insert_sample_data(session: Session):
    pattern1 = Patterns(id=1, name="pattern one", problem="Problem One", solution="Solution One", page_number=10, confidence=3, tag="tag1")
    pattern2 = Patterns(id=2, name="pattern two", problem="Problem Two", solution="Solution Two", page_number=20, confidence=2, tag="tag2")
